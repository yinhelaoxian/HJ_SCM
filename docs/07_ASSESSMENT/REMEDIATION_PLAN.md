...
| 问题 | 文件 | 预估工时 | 状态 |
|------|------|----------|------|
| JWT 安全漏洞修复 | `backend/supplier-auth/src/main/java/com/hjscm/auth/SupplierAuthService.java` | 4h | 待处理 |
| 数据库密码明文移除 | `docker-compose.yml` | 1h | 待处理 |
| 环境变量配置注入 | `.env.example` + `.gitignore` | 2h | 待处理 |
