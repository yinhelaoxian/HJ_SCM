...
| Mock 数据统一 | `src/services/mock.data.ts` + `mockAPI.ts` | 4h | ✅ 已完成 |

### 🟢 P2 - 中期优化（1-2个月）

| 问题 | 文件 | 预估工时 | 状态 |
|------|------|----------|------|
| MRP 数据链路打通 | MPS → MRP → 采购建议 | 16h | ✅ 已完成 |
| 前端 API 对接 | `src/services/api.ts` + Controller | 8h | ✅ 已完成 |
